...
const obraTabPlaceholders: {
...
}[] = [
  {
    ...
    title: "Cronograma",
    description:
      "Cronograma físico-financeiro da obra com etapas, marcos e % de avanço.",
  },
  {
    path: "contratos",
    icon: FileSignature,
    title: "Contratos",
    description:
      "Contratos da obra com clientes e fornecedores, aditivos e medições.",
  },
  {
    path: "equipe",
    icon: UsersRound,
    title: "Equipe",
    description:
      "Equipe alocada na obra com cargos, funções e período de atuação.",
  },
  {
    path: "rh",
    icon: Users,
  ...
  },
  {
    ...
    description:
      "Visão financeira da obra: títulos, previsão de desembolso e custos.",
  },
  {
    path: "estoque",
    icon: Package,
...
const funcionarioTabPlaceholders: {
  path: string;
  icon: LucideIcon;
  title: string;
  description: string;
}[] = [
  {
    ...
    title: "Contrato",
    description:
      "Dados contratuais do funcionário: tipo, vigência, cláusulas e aditivos.",
  },
  {
  ...
  },
  {
    ...
    title: "Documentos",
    description:
      "Documentos do funcionário: ASOs, certificados, contratos e comprovantes.",
  },
  {
    path: "alocacoes",
    icon: Building2,
  ...
  },
  {
    ...
    title: "FOPAG",
    description:
      "Participação do funcionário na folha de pagamento por competência.",
  },
];
    ...
    children: [
      {
        ...
        children: [
          ...
          // Fiscal
          {
            path: "/fiscal",
            element: <ModuleLayout />,
            children: [{ index: true, element: <FiscalListPage /> }],
          },
          ...
          // Estoque
          {
            path: "/estoque",
            element: <ModuleLayout />,
            children: [{ index: true, element: <EstoqueListPage /> }],
          },
          ...
          // Medições e Faturamento
          {
            path: "/medicoes",
            element: <ModuleLayout />,
            children: [{ index: true, element: <MedicoesListPage /> }],
          },
          ...
          // Documentos
          {
            path: "/documentos",
            element: <ModuleLayout />,
            children: [{ index: true, element: <DocumentosListPage /> }],
          },
          ...
          // Relatórios
          {
            path: "/relatorios",
            element: <ModuleLayout />,
            children: [{ index: true, element: <RelatoriosListPage /> }],
          },
