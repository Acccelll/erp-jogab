...
export const MODULE_READINESS: ModuleReadiness[] = [
  ...
  },
  {
    ...
    notes: 'Integrado na Fase 11. Dashboard, movimentações e detalhe de item com withApiFallback.',
  },
  {
    module: 'medicoes',
    status: 'ready',
    ...
    notes: 'Integrado na Fase 11. Dashboard, listagem e detalhe com withApiFallback.',
  },
  {
    module: 'documentos',
    status: 'ready',
