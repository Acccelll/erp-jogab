...
export const mockFuncionarios: Funcionario[] = [
  ...
  { id: 'func-12', matricula: 'MAT-012', nome: 'Rafael Lima', cpf: '555.666.777-88', status: 'ativo', tipoContrato: 'clt', cargo: 'Engenheiro de Instalações', funcao: 'Engenheiro Hospitalar', departamento: 'Engenharia', filialId: 'fil-1', filialNome: 'Matriz — São Paulo', empresaId: 'emp-1', obraAlocadoId: 'obra-7', obraAlocadoNome: 'Hospital da Luz', centroCustoId: 'cc-10', centroCustoNome: 'Hospital — Engenharia', dataAdmissao: '2025-01-10', dataDesligamento: null, salarioBase: 13500, email: 'rafael.lima@jogab.com.br', telefone: '(11) 99999-0012', cidade: 'São Paulo', uf: 'SP', gestorNome: 'Roberto Lima', gestorId: 'resp-3', createdAt: '2025-01-05T09:00:00Z', updatedAt: '2026-03-20T10:00:00Z' },
  { id: 'func-13', matricula: 'MAT-013', nome: 'Beatriz Costa', cpf: '888.999.000-11', status: 'ativo', tipoContrato: 'clt', cargo: 'Analista de Logística', funcao: 'Analista de Operações', departamento: 'Logística', filialId: 'fil-3', filialNome: 'Filial — Belo Horizonte', empresaId: 'emp-1', obraAlocadoId: 'obra-8', obraAlocadoNome: 'Galpão Logístico Sigma', centroCustoId: 'cc-11', centroCustoNome: 'Logistics — Operações', dataAdmissao: '2025-08-15', dataDesligamento: null, salarioBase: 5500, email: 'beatriz.costa@jogab.com.br', telefone: '(31) 97777-0013', cidade: 'Extrema', uf: 'MG', gestorNome: 'Marcos Santos', gestorId: 'resp-4', createdAt: '2025-08-10T11:00:00Z', updatedAt: '2026-03-18T16:00:00Z' },
  { id: 'func-14', matricula: 'MAT-014', nome: 'Gustavo Henrique', cpf: '444.333.222-11', status: 'ativo', tipoContrato: 'clt', cargo: 'Encarregado de Instalações', funcao: 'Encarregado', departamento: 'Produção', filialId: 'fil-1', filialNome: 'Matriz — São Paulo', empresaId: 'emp-1', obraAlocadoId: 'obra-7', obraAlocadoNome: 'Hospital da Luz', centroCustoId: 'cc-12', centroCustoNome: 'Hospital — Produção', dataAdmissao: '2025-02-01', dataDesligamento: null, salarioBase: 6200, email: 'gustavo.henrique@jogab.com.br', telefone: '(11) 99999-0014', cidade: 'São Paulo', uf: 'SP', gestorNome: 'Rafael Lima', gestorId: 'func-12', createdAt: '2025-01-25T10:00:00Z', updatedAt: '2026-03-15T14:00:00Z' },
  { id: 'func-15', matricula: 'MAT-015', nome: 'Larissa Nogueira', cpf: '999.888.777-66', status: 'ativo', tipoContrato: 'clt', cargo: 'Compradora', funcao: 'Compradora Pleno', departamento: 'Suprimentos', filialId: 'fil-1', filialNome: 'Matriz — São Paulo', empresaId: 'emp-1', obraAlocadoId: null, obraAlocadoNome: null, centroCustoId: null, centroCustoNome: null, dataAdmissao: '2024-05-15', dataDesligamento: null, salarioBase: 7800, email: 'larissa.nogueira@jogab.com.br', telefone: '(11) 99999-0015', cidade: 'São Paulo', uf: 'SP', gestorNome: 'Patricia Fernandes', gestorId: 'resp-5', createdAt: '2024-05-10T09:00:00Z', updatedAt: '2026-03-18T14:30:00Z' },
  { id: 'func-16', matricula: 'MAT-016', nome: 'Felipe Rocha', cpf: '222.111.000-99', status: 'ativo', tipoContrato: 'pj', cargo: 'Consultor de Planejamento', funcao: 'Consultor', departamento: 'Engenharia', filialId: 'fil-1', filialNome: 'Matriz — São Paulo', empresaId: 'emp-1', obraAlocadoId: 'obra-10', obraAlocadoNome: 'Viaduto do Trabalhador', centroCustoId: 'cc-13', centroCustoNome: 'Viaduto — Planejamento', dataAdmissao: '2025-04-01', dataDesligamento: null, salarioBase: 12000, email: 'felipe.rocha@jogab.com.br', telefone: '(11) 99999-0016', cidade: 'São Paulo', uf: 'SP', gestorNome: 'Carlos Oliveira', gestorId: 'resp-1', createdAt: '2025-03-25T10:00:00Z', updatedAt: '2026-03-15T09:00:00Z' },
];
