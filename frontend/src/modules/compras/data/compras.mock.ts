...
export const mockSolicitacoesCompra: SolicitacaoCompra[] = [
  ...
  },
  {
    id: 'sol-005',
    codigo: 'SC-2026-005',
    titulo: 'Equipamentos de Climatização Hospitalar',
    descricao: 'Sistemas de ar condicionado para áreas cirúrgicas.',
    solicitanteNome: 'Rafael Lima',
    obraId: 'obra-7',
    obraNome: 'OBR-007 — Hospital da Luz',
    centroCustoNome: 'Hospital — Engenharia',
    competencia: '2026-03',
    categoria: 'equipamento',
    prioridade: 'alta',
    status: 'pedido_emitido',
...
export const mockPedidosCompra: PedidoCompra[] = [
  ...
  },
  {
    ...
    cotacaoId: null,
    fornecedorId: 'for-045',
    fornecedorNome: 'Carrier Brasil',
    obraId: 'obra-7',
    obraNome: 'OBR-007 — Hospital da Luz',
    centroCustoNome: 'Hospital — Engenharia',
    competencia: '2026-03',
    ...
    status: 'pedido_emitido',
    valorPedido: 850000,
    valorComprometidoFinanceiro: 850000,
    previsaoEntrega: '2026-05-15',
    fiscalStatus: 'nao_iniciado',
    financeiroStatus: 'previsto',
    itens: 1,
