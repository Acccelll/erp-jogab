import type { ComprasResumoCard as ComprasResumoCardType } from '../types';

interface ComprasResumoCardProps {
  card: ComprasResumoCardType;
}

export function ComprasResumoCard({ card }: ComprasResumoCardProps) {
  return (
