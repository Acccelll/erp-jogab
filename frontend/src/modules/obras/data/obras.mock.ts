...
export const mockObras: Obra[] = [
  ...
  { id: 'obra-7', codigo: 'OBR-007', nome: 'Hospital da Luz', descricao: 'Construção de complexo hospitalar com 150 leitos e áreas cirúrgicas.', status: 'em_andamento', tipo: 'industrial', clienteNome: 'Saúde & Vida S.A.', clienteId: 'cli-7', responsavelNome: 'Roberto Lima', responsavelId: 'resp-3', filialId: 'fil-1', filialNome: 'Matriz — São Paulo', empresaId: 'emp-1', endereco: 'Rua das Flores, 500', cidade: 'São Paulo', uf: 'SP', dataInicio: '2025-01-10', dataPrevisaoFim: '2027-12-31', dataFimReal: null, percentualConcluido: 25, orcamentoPrevisto: 45000000, custoRealizado: 8500000, custoComprometido: 5200000, totalFuncionarios: 3, totalContratos: 15, createdAt: '2024-12-01T09:00:00Z', updatedAt: '2026-03-20T10:00:00Z' },
  { id: 'obra-8', codigo: 'OBR-008', nome: 'Galpão Logístico Sigma', descricao: 'Centro de distribuição logística com 12.000m² e pátio de manobras.', status: 'em_andamento', tipo: 'industrial', clienteNome: 'Logistics Pro', clienteId: 'cli-8', responsavelNome: 'Marcos Santos', responsavelId: 'resp-4', filialId: 'fil-3', filialNome: 'Filial — Belo Horizonte', empresaId: 'emp-1', endereco: 'Rodovia Fernão Dias, Km 20', cidade: 'Extrema', uf: 'MG', dataInicio: '2025-08-15', dataPrevisaoFim: '2026-09-30', dataFimReal: null, percentualConcluido: 52, orcamentoPrevisto: 15000000, custoRealizado: 6200000, custoComprometido: 1800000, totalFuncionarios: 2, totalContratos: 8, createdAt: '2025-07-15T11:00:00Z', updatedAt: '2026-03-18T16:00:00Z' },
  { id: 'obra-9', codigo: 'OBR-009', nome: 'Solaris Residences', descricao: 'Condomínio de casas sustentáveis com energia solar e reuso de água.', status: 'planejamento', tipo: 'residencial', clienteNome: 'Green Life Inc.', clienteId: 'cli-9', responsavelNome: 'Ana Souza', responsavelId: 'resp-2', filialId: 'fil-2', filialNome: 'Filial — Rio de Janeiro', empresaId: 'emp-1', endereco: 'Estrada do Pontal, 1200', cidade: 'Rio de Janeiro', uf: 'RJ', dataInicio: '2026-05-01', dataPrevisaoFim: '2028-04-30', dataFimReal: null, percentualConcluido: 0, orcamentoPrevisto: 28000000, custoRealizado: 0, custoComprometido: 450000, totalFuncionarios: 0, totalContratos: 1, createdAt: '2026-02-10T14:00:00Z', updatedAt: '2026-03-10T09:00:00Z' },
  { id: 'obra-10', codigo: 'OBR-010', nome: 'Viaduto do Trabalhador', descricao: 'Obras de arte especial para transposição de via férrea.', status: 'em_andamento', tipo: 'infraestrutura', clienteNome: 'Prefeitura de Campinas', clienteId: 'cli-10', responsavelNome: 'Carlos Oliveira', responsavelId: 'resp-1', filialId: 'fil-1', filialNome: 'Matriz — São Paulo', empresaId: 'emp-1', endereco: 'Av. das Nações Unidas, s/n', cidade: 'Campinas', uf: 'SP', dataInicio: '2025-03-10', dataPrevisaoFim: '2026-10-15', dataFimReal: null, percentualConcluido: 38, orcamentoPrevisto: 12500000, custoRealizado: 4250000, custoComprometido: 1200000, totalFuncionarios: 0, totalContratos: 4, createdAt: '2025-02-20T10:00:00Z', updatedAt: '2026-03-15T14:00:00Z' },
];
