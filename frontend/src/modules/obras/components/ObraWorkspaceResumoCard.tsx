import type { ObraWorkspaceResumoCard as ObraWorkspaceResumoCardData } from '../types';

export function ObraWorkspaceResumoCard({ card }: { card: ObraWorkspaceResumoCardData }) {
  return (
