...
const titulos: TituloFinanceiro[] = [
  ...
  },
  {
    ...
    status: 'programado',
    origem: 'fopag',
    descricao: 'Folha salarial - Hospital da Luz - março/2026',
    obraId: 'obra-7',
    obraNome: 'OBR-007 — Hospital da Luz',
    centroCusto: 'CC-HOS-ENG',
    competencia: '2026-03',
    fornecedorCliente: 'Rafael Lima e Equipe',
    emissao: '2026-03-01',
    vencimento: '2026-03-25',
    pagamentoRecebimentoPrevisto: '2026-03-25',
    valor: 45800.00,
    valorPagoRecebido: 0,
    observacao: 'Rateio de pessoal técnico alocado ao Hospital.',
  },
  {
    id: 'tit-008',
    codigo: 'TIT-2026-008',
    ...
    status: 'previsto',
    origem: 'compras',
    descricao: 'Compra de Equipamentos de Climatização - Hospital',
    obraId: 'obra-7',
    obraNome: 'OBR-007 — Hospital da Luz',
    centroCusto: 'CC-HOS-ENG',
    competencia: '2026-03',
    fornecedorCliente: 'Carrier Brasil',
    emissao: '2026-03-12',
    vencimento: '2026-05-30',
    pagamentoRecebimentoPrevisto: '2026-05-30',
    valor: 850000.00,
    valorPagoRecebido: 0,
    observacao: 'Valor total do pedido PC-2026-045 comprometido no financeiro.',
  },
];
