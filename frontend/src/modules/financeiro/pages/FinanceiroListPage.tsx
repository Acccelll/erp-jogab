      ...
      <MainContent className="space-y-4">
        ...
        {!isLoading && !isError && data && (
          <>
            ...
            {/* Custo de pessoal — collapsible secondary panel */}
            {pessoal && (
              <section className="rounded-lg border border-border-default bg-surface-card">
                ...
                >
                  <div className="flex items-center gap-2">
                    <ChevronDown
                      size={14}
                      className={cn('text-text-subtle transition-transform', !pessoalOpen && '-rotate-90')}
                    />
                    <h2 className="text-xs font-semibold uppercase tracking-wider text-text-subtle">
                      Custo de pessoal por obra
                    </h2>
                    <span className="text-xs text-text-muted">
                      {formatCompetencia(pessoal.competencia.competencia)} · {pessoal.competencia.totalFuncionarios}{' '}
                      func.
                    </span>
                  </div>
                  <StatusBadge
                ...
                {pessoalOpen && (
                  <div className="border-t border-border-light px-3 pb-3">
                      ...
                      <table className="min-w-full text-sm">
                        <thead>
                          <tr className="border-b border-border-default bg-surface-muted">
                            ...
                            <th className="px-3 py-1.5 text-right text-xs font-medium text-text-muted">
                              FOPAG prevista
                            </th>
