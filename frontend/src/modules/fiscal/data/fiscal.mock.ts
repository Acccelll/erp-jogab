...
export const fiscalDocumentos: DocumentoFiscal[] = [
  ...
  },
  {
    ...
    documentoTipo: 'nfe',
    status: 'validado',
    emitenteNome: 'Carrier Brasil',
    destinatarioNome: 'JOGAB Engenharia',
    obraId: 'obra-7',
    obraNome: 'OBR-007 — Hospital da Luz',
    competencia: '2026-03',
    emissao: '2026-03-12',
    lancamento: '2026-03-13',
    vencimento: '2026-05-30',
    valorDocumento: 850000,
    chaveAcesso: '35260385000000000001550010000015021012345678',
    resumo: 'Nota fiscal de equipamentos de climatização para o Hospital da Luz.',
    impostos: {
      baseCalculo: 850000,
      valorIcms: 153000,
      valorPis: 5525,
      valorCofins: 25500,
      valorRetencoes: 0,
      valorTotalImpostos: 184025,
    },
    vinculos: {
      compraCodigo: 'PC-2026-045',
      pedidoCompraHref: '/compras/pedidos/ped-004',
      obraId: 'obra-7',
      obraNome: 'OBR-007 — Hospital da Luz',
      estoqueStatus: 'pendente',
      tituloFinanceiroCodigo: 'TIT-2026-008',
      tituloFinanceiroHref: '/financeiro/titulos/tit-008',
      financeiroStatus: 'integrado',
    },
  },
];
