import type { FiscalResumoCard as FiscalResumoCardType } from '../types';

interface FiscalResumoCardProps {
  card: FiscalResumoCardType;
}

export function FiscalResumoCard({ card }: FiscalResumoCardProps) {
  return (
