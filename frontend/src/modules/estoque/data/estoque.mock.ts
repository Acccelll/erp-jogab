...
const estoqueItens: EstoqueItem[] = [
  ...
  {
    id: 'item-007', codigo: 'MAT-EPO-040', descricao: 'Selante de Piso Epóxi', unidade: 'GL', tipo: 'material', status: 'disponivel', obraId: 'obra-8', obraNome: 'OBR-008 — Galpão Logístico Sigma', localId: 'almox-8', localNome: 'Almoxarifado Extrema', centroCusto: 'CC-LOG-OPER', competencia: '2026-03', fornecedorPrincipal: 'Química Sigma', saldo: { quantidadeAtual: 45, quantidadeReservada: 5, quantidadeDisponivel: 40, quantidadeMinima: 10, quantidadeMaxima: 60, custoMedioUnitario: 185, valorTotal: 8325, coberturaDias: 30 }, consumoMedioMensal: 12, ultimaMovimentacaoEm: '2026-03-18',
  },
];
...
const estoqueMovimentacoes: EstoqueMovimentacao[] = [
  ...
  { id: 'mov-008', itemId: 'item-007', itemCodigo: 'MAT-EPO-040', itemDescricao: 'Selante de Piso Epóxi', tipo: 'entrada_compra', status: 'disponivel', origem: 'compras', obraId: 'obra-8', obraNome: 'OBR-008 — Galpão Logístico Sigma', localId: 'almox-8', localNome: 'Almoxarifado Extrema', centroCusto: 'CC-LOG-OPER', competencia: '2026-03', quantidade: 50, unidade: 'GL', valorMovimento: 9250, saldoAposMovimento: 45, responsavelNome: 'Beatriz Costa', observacao: 'Entrada para finalização do piso industrial.', dataMovimentacao: '2026-03-18' },
];
