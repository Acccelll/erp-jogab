  ...
  return (
    <FilterBar onClear={hasActiveFilters ? onClear : undefined}>
      ...
      <input
        ...
        className="h-8 rounded-md border border-gray-200 bg-white px-2 text-sm text-gray-700 focus:border-jogab-500 focus:outline-none focus:ring-1 focus:ring-jogab-500"
      />
    </FilterBar>
  );
}
