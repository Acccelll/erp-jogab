...
import type { MedicoesResumoCardData } from '../types';

interface MedicoesResumoCardProps {
  card: MedicoesResumoCardData;
}

export function MedicoesResumoCard({ card }: MedicoesResumoCardProps) {
  return (
